...
//変数の定義---------------------------------------------------------------------
    ...
    var kekka_yuukou = 0;
    const question = [
      ["プロジェクションマッピングの映像に出てくる、黄色い背景にふわふわと浮かび上がるシャボン玉は、働く前の女性が抱いている仕事やプライベートでの将来の何を表現しているかな？", 
       "青いクリスタルの上に出てくる、「鎖」は育児や介護などのライフイベントによる何を表現しているかな？", 
       "女性にしか起きないライフイベントは何かな？"],//第1問(1班)
      ["衣装の袖口、襟元などLGBTQのマークに使われている虹色は何というでしょう？", 
       "衣装全体の生地はオーロラ生地にしてるよ。これは、○○の多様性を表しているよ。○○とはなーんだ？", 
       "マントは、何を表しているでしょう？"],//第2問
      ["衣装の胸元の黄色い花は、何を表しているでしょう？",
       "スカートの上に被さっている檻のようなスカートは、何でしょう？",
       "スカートの上の青い光は、オンライン化による新たな何を表しているでしょうか？"],//第3問
      ["衣装はどの時代を表しているでしょうか？",
    ...
    const groupthema = [
      ["第1問!","テーマ「女性が正規雇用で継続して働ける社会」"],//1班
      ["第2問!","テーマ「セックスとジェンダー」"],//2班
      ["第3問!","テーマ「コロナによる入学式/卒業式の変化」"],//3班
      ["第4問!","テーマ「女性アイドルにおける人数と変遷」"],//4班
      ["",""],//ダミー
    ];
